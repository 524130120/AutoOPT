...
respectively. The class diagram is given in [Figure 3](#Figure3). An object of the DESIGN class is a designed algorithm with several properties, e.g., operator (components that constitute the algorithm), parameter
...
space. Then, the algorithms’ performance on solving the “training” instances <sup>[2](#note2)</sup> of the target problem
...
<a id="note2"></a>2. Since the distribution of instances of a real problem is often unknown, one has to sample some of the problem
